...
export default function SidebarContent({ onNavigate, userName, companyName }) {
  return (
    <div className="flex h-full min-h-0 flex-col gap-4 px-2 py-1">
      <div className="rounded-2xl border border-slate-300/50 bg-white/55 p-3 dark:border-slate-700/60 dark:bg-slate-900/45">
        <div className="space-y-3">
          <BrandLogo onClick={onNavigate} />
          <div className="space-y-2">
            <h2 className="font-display text-2xl font-bold leading-tight">Growth command center</h2>
      ...
      <div className="mt-1 rounded-3xl border border-slate-300/50 bg-gradient-to-b from-white/70 to-slate-100/70 p-4 dark:border-slate-700/60 dark:from-slate-900/60 dark:to-slate-900/20">
